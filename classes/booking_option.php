    ...
    public static function get_progressbar_html(
        ...
        if ($consumedpercentage > 0 && $consumedpercentage <= 100) {
            ...
            if ($collapsible) {
                ...
                $html .=
                    "<p class='mb-0 mt-1'>
                        $icon <a data-toggle='collapse' data-bs-toggle='collapse' href='#progressbarContainer$optionid'
                        role='button' aria-expanded='false'
                        aria-controls='progressbarContainer$optionid'>$alreadypassed: $consumedpercentage%</a>
                    </p>
