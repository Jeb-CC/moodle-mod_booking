...
class teachers_instance_report_table extends table_sql {
    ...
    public function col_units_courses($values) {
        ...
        if (!$this->is_downloading()) {
            $retstring = '<a data-toggle="collapse" data-bs-toggle="collapse" href="#optionsforteacher-' . $values->teacherid .
    ...
    public function col_missinghours($values) {
        ...
        if (!$this->is_downloading()) {
            $retstring = '<a data-toggle="collapse" data-bs-toggle="collapse" href="#missinghoursforteacher-' . $values->teacherid .
    ...
    public function col_substitutions($values) {
        ...
        if (!$this->is_downloading()) {
            $retstring = '<a data-toggle="collapse" data-bs-toggle="collapse" href="#substitutionsforteacher-' .
                $values->teacherid .
